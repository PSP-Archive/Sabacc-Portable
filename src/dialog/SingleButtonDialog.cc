...
SingleButtonDialog::SingleButtonDialog(const Rect& position, const string& property_string) :
  ...
  dialog_button("") { }
SingleButtonDialog::SingleButtonDialog(const string& text, const string& title, const string& button_text, const Rect& position, const string& property_string) :
  DialogBase(position, property_string), dialog_text(text), dialog_title(title), dialog_button(button_text) { }
...
string SingleButtonDialog::getDialogText() { return(dialog_text.getText()); }
void SingleButtonDialog::setDialogText(std::string text) { 
  dialog_text.setText(text);
  setNotInitialized();
}
string SingleButtonDialog::getDialogTitle() { return(dialog_title.getText()); }
void SingleButtonDialog::setDialogTitle(std::string title) { 
  dialog_title.setText(title); 
  setNotInitialized();
}
string SingleButtonDialog::getDialogButtontext() { return(dialog_button.getText()); }
void SingleButtonDialog::setDialogButtonText(std::string button_text) { 
  dialog_button.setText(button_text);
  setNotInitialized();
}

bool SingleButtonDialog::onKeyDown(const SDL_KeyboardEvent& key) {
...
bool SingleButtonDialog::onKeyUp(const SDL_KeyboardEvent&) {
    return(true);
}

bool SingleButtonDialog::onJoystickButtonDown(const SDL_JoyButtonEvent& joystick_event) {
...
bool SingleButtonDialog::onJoystickButtonUp(const SDL_JoyButtonEvent&) {
    return(true);
}
bool SingleButtonDialog::onJoystickMove(const SDL_JoyAxisEvent&) {
    return(true);
}
bool SingleButtonDialog::onJoystickHat(const SDL_JoyHatEvent&) {
    return(true);
}
bool SingleButtonDialog::onJoystickBall(const SDL_JoyBallEvent&) {
    return(true);
}

bool SingleButtonDialog::onMouseMove(const SDL_MouseMotionEvent&) {
    return(true);
}
bool SingleButtonDialog::onMouseButtonDown(const SDL_MouseButtonEvent&) {
    return(true);
}
bool SingleButtonDialog::onMouseButtonUp(const SDL_MouseButtonEvent&) {
    return(true);
}
