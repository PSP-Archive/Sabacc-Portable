...
string OKCancelDialog::getDialogTitle() { return(dialog_title); }
void OKCancelDialog::setDialogTitle(std::string title) { 
  dialog_title = title; 
  setNotInitialized();
}
string OKCancelDialog::getDialogOKButtonText() { return(ok_button); }
void OKCancelDialog::setDialogOKButtonText(std::string button) { 
  ok_button = button;
  setNotInitialized();
}
string OKCancelDialog::getDialogCancelButtonText() { return(cancel_button); }
